...
def main():
    # load mnist dataset:
    x_test=np.load('C:/Users/sergio.muniz/Desktop/QUBOSergio/ADARound/itcl-quantization-toolkit/quantizer/qubo_adaround/X_test.npy') 
    y_test=np.load('C:/Users/sergio.muniz/Desktop/QUBOSergio/ADARound/itcl-quantization-toolkit/quantizer/qubo_adaround/y_test.npy')

    data = x_test[:1473]  # first 1000 samples
    ...
    print("Network Loss:", loss(seq_net)/1473)
